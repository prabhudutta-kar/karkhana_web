  ...
  (SEMICOLON.initialize = {
    ...
    goToTop: function () {
      ...
      e || (e = 700),
        ...
        $goToTopEl.off("click").on("click", function () {
          return (
            $("body,html").stop(!0).animate({ scrollTop: 0 }, Number(e), t), !1
          );
        });
    },
    ...
    setFullColumnWidth: function (e) {
      ...
      if ((e.css({ width: "" }), e.hasClass("portfolio-full"))) {
        ...
        i = a / t;
        (i = Math.floor(i)) * t >= a && e.css({ "margin-right": "-1px" }),
        ...
        if (n) {
          ...
          for (l = 0; l < n.length; l++)
            (r = Number(n[l]) - 1),
              e.find("a:eq(" + r + ")").css({ width: 2 * o + "px" });
          setTimeout(function () {
            e.isotope("layout");
          }, 1e3);
        }
      ...
      menufunctions: function () {
        $("#primary-menu ul li:has(ul)").addClass("sub-menu"),
          ...
          ($("#primary-menu").hasClass("on-click") ||
            ...
            $("#primary-menu li:has(ul) > a").on("click touchend", function (
              e
            ) {
              $(this)
                .parents(".sub-menu")
          ...
          if (t + e + 50 > $window.scrollTop())
            if (
              ...
              if ($sliderParallaxEl.find(".slider-parallax-inner").length > 0) {
                ...
                $sliderParallaxEl.css({ transform: "translateY(" + a + "px)" }),
                  $(".slider-parallax .slider-caption,.ei-title").css({
                    transform: "translateY(" + -i + "px)",
                  });
              }
          ...
          if (
            ...
            if ($slider.length > 0) {
              ...
              $sliderParallaxEl
                ...
                .css({ opacity: 1 - (1.85 * ($window.scrollTop() - t)) / e });
            }
          }
      },
          ...
          t.each(function () {
            ...
            e.addClass("customjs"),
              ...
              "user" == s
                ...
                : "list" == s &&
                  $.jribbble
                    .shots(i, { sort: "recent", page: 1, per_page: Number(a) })
                    .then(function (t) {
                      var a = [];
                      t.forEach(function (e) {
                        a.push('<a href="' + e.html_url + '" target="_blank">'),
        ...
        if ($cookieNotification.length > 0) {
          ...
          $cookieNotification.css({ bottom: -e }),
            ...
            $(".cookie-accept")
              ...
              .on("click", function () {
                return (
                  $cookieNotification.css({ bottom: -e, opacity: 0 }),
